...
[方案 C 交付與後續](方案C開發規劃.md) · [RDQ 已確認規格](rdq/RDQ-spec-c-skins-20260906.md) · [Blender MCP 安裝與實測](Blender-MCP安裝與驗證.md)。Blender MCP 已實際讀取場景、修改電漿發光材質、匯出 GLB 與取得視窗截圖；Codex 新增原生工具需重開應用程式後載入。
